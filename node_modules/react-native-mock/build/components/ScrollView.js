...
var _EdgeInsetsPropType = require('../propTypes/EdgeInsetsPropType');

var _EdgeInsetsPropType2 = _interopRequireDefault(_EdgeInsetsPropType);

var _PointPropType = require('../propTypes/PointPropType');
...
var ScrollView = _react2.default.createClass({
  ...
  endRefreshin: function () {
    function endRefreshin() {
  ...
  scrollTo: function () {
    function scrollTo() {
      var destY = arguments.length <= 0 || arguments[0] === undefined ? 0 : arguments[0];
      var destX = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
