...
var NetInfo = {
  addEventListener: function () {
    function addEventListener(eventname, handler) {
      var listener = _DeviceEventEmitter2.default.addListener(DEVICE_CONNECTIVITY_EVENT, function (_ref) {
        var network_info = _ref.network_info;
        return handler(network_info);
      });
  ...
  isConnected: {
    ...
    fetch: function () {
      function fetch() {
        return NetInfo.fetch().then(function (info) {
  ...
  isConnectionExpensive: function () {
    function isConnectionExpensive(callback) {
  ...
  __setNetworkInfo: function () {
    function __setNetworkInfo(info) {
      networkInfo = info;
    }

    return __setNetworkInfo;
  }(),
  __setIsConnectionExpensive: function () {
    function __setIsConnectionExpensive(expensive) {
      isExpensive = expensive;
    }

    return __setIsConnectionExpensive;
  }(),
  __setIsConnected: function () {
    function __setIsConnected(connected) {
