...
var _CameraRollManager = require('../NativeModules/CameraRollManager');

var _CameraRollManager2 = _interopRequireDefault(_CameraRollManager);
...
var CameraRoll = function () {
  ...
  _createClass(CameraRoll, null, [{
     ...
     */
    value: function () {
      function saveImageWithTag(tag) {
        (0, _invariant2.default)(typeof tag === 'string', 'CameraRoll.saveImageWithTag tag must be a valid string.');
        // TODO(lmr):
