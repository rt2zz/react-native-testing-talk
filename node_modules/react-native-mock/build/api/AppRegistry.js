...
var AppRegistry = {
  registerConfig: function () {
    function registerConfig(configs) {}

    return registerConfig;
  }(),
  registerComponent: function () {
    function registerComponent(appKey, getComponentFunc) {
      return appKey;
    }
  ...
  registerRunnable: function () {
    function registerRunnable(appKey, func) {
