...
var _AlertManager = require('../NativeModules/AlertManager');
...
var AlertIOS = function () {
  ...
  _createClass(AlertIOS, null, [{
     ...
     */
    value: function () {
      function alert(title, message, callbackOrButtons, type) {
    ...
    key: 'prompt',
    value: function () {
      function prompt(title, message, callbackOrButtons, type, defaultValue) {
