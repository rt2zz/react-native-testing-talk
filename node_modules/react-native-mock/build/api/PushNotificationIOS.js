...
var PushNotificationIOS = function () {
  _createClass(PushNotificationIOS, null, [{
    ...
    value: function () {
      ...
      return setApplicationIconBadgeNumber;
    }()
    ...
    value: function () {
      function addEventListener(type, handler) {
        (0, _invariant2.default)(type === 'notification' || type === 'register', 'PushNotificationIOS only supports `notification` and `register` events');
        var listener;
        if (type === 'notification') {
          listener = _DeviceEventEmitter2.default.addListener(DEVICE_NOTIF_EVENT, function (notifData) {
            handler(new PushNotificationIOS(notifData));
          });
        } else if (type === 'register') {
          listener = _DeviceEventEmitter2.default.addListener(NOTIF_REGISTER_EVENT, function (registrationInfo) {
