...
var Settings = {
  ...
  watchKeys: function () {
    function watchKeys(keys, callback) {
      if (typeof keys === 'string') {
        keys = [keys];
      }

      (0, _invariant2.default)(Array.isArray(keys), 'keys should be a string or array of strings');
  ...
  _sendObservations: function () {
    function _sendObservations(body) {
      var _this = this;
  ...
  __emulateDeviceSettingsChange: function () {
    function __emulateDeviceSettingsChange(settings) {
      _DeviceEventEmitter2.default.emit('settingsUpdated', settings);
    }

    return __emulateDeviceSettingsChange;
  }()
};

_DeviceEventEmitter2.default.addListener('settingsUpdated', Settings._sendObservations.bind(Settings));
