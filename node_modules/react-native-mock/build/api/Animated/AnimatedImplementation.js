...
var _flattenStyle = require('../../propTypes/flattenStyle');
...
var Animation = function () {
  ...
  _createClass(Animation, [{
    key: 'start',
    value: function () {
      function start(fromValue, onUpdate, onEnd, previousAnimation) {}
...
var TimingAnimation = function (_Animation) {
  ...
  _createClass(TimingAnimation, [{
    key: 'start',
    value: function () {
      function start(fromValue, onUpdate, onEnd) {
        var _this3 = this;
  ...
  _createClass(AnimatedValueXY, [{
    ...
    value: function () {
      function addListener(callback) {
        ...
        var id = String(_uniqueId++);
        var jointCallback = function () {
          function jointCallback(_ref) {
...
var AnimatedTracking = function (_Animated3) {
  ...
  function AnimatedTracking(value, parent, animationClass, animationConfig, callback) {
    ...
    var _this18 = _possibleConstructorReturn(this, Object.getPrototypeOf(AnimatedTracking).call(this));
