...
var _TextInputState = require('../api/TextInputState');
...
var _UIManager = require('../NativeModules/UIManager');
...
var ScrollResponderMixin = {
  ...
  scrollResponderScrollTo: function () {
    function scrollResponderScrollTo(offsetX, offsetY) {
  ...
  scrollResponderZoomTo: function () {
    function scrollResponderZoomTo(rect) {
  ...
  scrollResponderScrollNativeHandleToKeyboard: function () {
    function scrollResponderScrollNativeHandleToKeyboard(nodeHandle, additionalOffset, preventNegativeScrollOffset) {
      ...
      _UIManager2.default.measureLayout(nodeHandle, _react2.default.findNodeHandle(this.getInnerViewNode()), this.scrollResponderTextInputFocusError, this.scrollResponderInputMeasureAndScrollToKeyboard);
    }
