...
var TextStylePropTypes = _extends(Object.create(_ViewStylePropTypes2.default), {
   ...
   */
  fontWeight: PropTypes.oneOf(['normal' /*default*/, 'bold', '100', '200', '300', '400', '500', '600', '700', '800', '900']),
   ...
   */
  textAlign: PropTypes.oneOf(['auto' /*default*/, 'left', 'right', 'center', 'justify']),
  /**
   * @platform android
   */
  textAlignVertical: PropTypes.oneOf(['auto' /*default*/, 'top', 'bottom', 'center']),
  /**
   * @platform ios
   */
  textDecorationLine: PropTypes.oneOf(['none' /*default*/, 'underline', 'line-through', 'underline line-through']),
  /**
   * @platform ios
   */
  textDecorationStyle: PropTypes.oneOf(['solid' /*default*/, 'double', 'dotted', 'dashed']),
  /**
   * @platform ios
   */
   ...
   * @platform ios
   */
  writingDirection: PropTypes.oneOf(['auto' /*default*/, 'ltr', 'rtl'])
});
